...
Vous pouvez m'appeler Teva ! Je suis étudiant 👨‍🎓 en L3 informatique à l'Université Savoie Mont Blanc aux Bourget du Lac mais aussi président du bureau des étudiants 👨‍💼 !
...
- [ ] Implémentation web d'un [jeu d'histoire interractive](https://github.com/jtrognon/L1_Projet_Jeux_Web). Implémentations d'une structure de donnée particulière et bien plus 🔖 !

## Mes projets terminés ✔️ : 
- [x] Dans le cadre du CMI, une étude sur la [colorimétrie propre des graphes](https://github.com/TevaPhilippe05/L2_Recherche_Colorimetrie_Graphes) à travers des algorithmes gloutons 🔯 .
...
- [x] Participation à la [nuit de l'info 2025](https://github.com/TevaPhilippe05/Nuit-Info-2025). Il s'agissait d'un site avec une partie jeu dont un snake caché et une partie forum à but éducatif sur la lutte contre le gaspillage numérique.
